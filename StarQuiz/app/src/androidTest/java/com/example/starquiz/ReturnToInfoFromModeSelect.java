...
public class ReturnToInfoFromModeSelect {
    ...
    @Test
    public void returnToInfoFromModeSelect() {
        ...
        ViewInteraction appCompatEditText2 = onView(
                allOf(withId(R.id.usernameEditText),
                        childAtPosition(
                                ...
                                1),
                        isDisplayed()));
        appCompatEditText2.perform(replaceText("vic"), closeSoftKeyboard());
        ...
        ViewInteraction materialButton3 = onView(
                allOf(withId(R.id.ModeToInfoReturn), withText("Return"),
                        childAtPosition(
                                childAtPosition(
                                        withId(android.R.id.content),
                                        0),
