...
public class HomeActivityTestPathToQuestions {
    ...
    @Test
    public void homeActivityTestPathToQuestions() {
        ...
        ViewInteraction appCompatEditText2 = onView(
                allOf(withId(R.id.usernameEditText),
                        childAtPosition(
                                ...
                                1),
                        isDisplayed()));
        appCompatEditText2.perform(replaceText("testingName"), closeSoftKeyboard());
